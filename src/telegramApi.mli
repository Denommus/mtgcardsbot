...
val makeInputTextMessageContent : message_text:string -> ?parse_mode:string -> ?disable_web_page_preview:bool -> unit -> inputMessageContent
...
val onPollingError : bot -> ('a Js.t -> unit) -> unit
